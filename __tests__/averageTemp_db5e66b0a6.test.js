...
describe('averageTemp function', () => {
  ...
  test('should handle edge cases', () => {
    ...
    expect(averageTemp(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER)).toBe(Number.MAX_SAFE_INTEGER);
    expect(averageTemp(Number.MIN_SAFE_INTEGER, Number.MIN_SAFE_INTEGER)).toBe(Number.MIN_SAFE_INTEGER);
  });
