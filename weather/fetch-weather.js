...
function processResults(allResults) {
  ...
  return {
    minTemp: kelvinToCelcius(allResults?.main?.temp_min || 10), // Celsius
    maxTemp: kelvinToCelcius(allResults?.main?.temp_max || 10), // Celsius
    chanceRain: 0.83, // 0 - 1 //TODO find new api
    rainFall: getRainFall(allResults?.rain), // mm
    cloudCover: allResults?.clouds?.all || 10, // percentage
  };
}
