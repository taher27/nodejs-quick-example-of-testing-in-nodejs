...
var fetchWeather = require('./fetch-weather.js');
...
describe('fetchWeather', function () {
  ...
  describe('#getRainFall()', function () {
    ...
    it('should return 0 when no argument is passed', function () {
      assert.equal(fetchWeather.getRainFall(), 0);
    });
